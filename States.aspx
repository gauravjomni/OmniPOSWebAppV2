<%@ Page Language="C#"  MasterPageFile="~/innerpage.master" AutoEventWireup="true"  CodeFile="~/States.aspx.cs" Inherits="PosState.States"  %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
			...
			<ul class="shortcut-buttons-set">
				...
				<li><a class="shortcut-button" href="AddState.aspx"><span>
...
--%>				
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
					...
					<h3 style="cursor: s-resize;">Current State(s)</h3>
					
					<ul class="content-box-tabs">
						<li><a href="#tab1" class="default-tab current">State(s)</a></li> <!-- href must be unique and match the id of target div -->
                          ...
                          <asp:Repeater ID="UserGroupRepeater" runat="server">
							...
							<ItemTemplate>
								<tr class="alt-row">
									...
									<td>
										<!-- Icons -->
										 <a href='<%# "AddState.aspx?stid=" + iTool.encryptString(DataBinder.Eval(Container.DataItem,"StateID").ToString()) + "&mode=edit" %>' title="Edit"><img src="images/pencil.png" alt="Edit"></a>
                                         <a href="javascript:;" title="Delete" onclick="removerec('<%# iTool.encryptString(DataBinder.Eval(Container.DataItem,"StateID").ToString())%>','States.aspx')"><img src="images/cross.png" alt="Delete"></a>
									</td>
								</tr>
							</ItemTemplate>
