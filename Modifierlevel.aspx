<%@ Page Language="C#"  MasterPageFile="~/innerpage.master" AutoEventWireup="true"  CodeFile="~/Modifierlevel.aspx.cs" Inherits="PosModifiers.ModifiersLevel"  %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
			...
			<ul class="shortcut-buttons-set">
				...
				<li><a class="shortcut-button" href="AddModifierLevel.aspx"><span>
					<img src="images/pencil_48.png" alt="icon"><br>
					Add Modifier Level
				</span></a></li>
				
<%--				<li><a class="shortcut-button" href="Modifierlevel.aspx"><span>
...
--%>				
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
					...
					<h3 style="cursor: s-resize;">Current Modifier Level(s)</h3>
					
					<ul class="content-box-tabs">
						<li><a href="#tab1" class="default-tab current">Modifer Level</a></li> <!-- href must be unique and match the id of target div -->
					...
					<div style="display: block;" class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
					    ...
					    <asp:Literal ID="Msg" runat="server" Visible="false">
						    <div class="notification attention png_bg">
							    ...
							    <div>Permission Denied! This Modifier Level Is Already Attached With Any Modifier. Please Delete That Modifier First And Then You Can Delete That Modifier Level.</div>
						    </div>
					    </asp:Literal>		
                          ...
                          <asp:Repeater ID="ModFLevelRepeater" runat="server" OnItemDataBound="ModFLevelRepeater_ItemDataBound">
							<HeaderTemplate>
							<tbody>
							</HeaderTemplate>
							<ItemTemplate>
								<tr class="alt-row">
									...
									<td>
										<!-- Icons -->
										 <a href='<%# "AddModifierLevel.aspx?modfid=" + iTool.encryptString(DataBinder.Eval(Container.DataItem,"LevelID").ToString()) + "&mode=edit" %>' title="Edit"><img src="images/pencil.png" alt="Edit"></a>
										 <a href="javascript:;" title="Delete" onclick="removerec('<%# iTool.encryptString(DataBinder.Eval(Container.DataItem,"LevelID").ToString())%>','Modifierlevel.aspx')"><img src="images/cross.png" alt="Delete"></a>
										 <a href='<%# "AddModifierLevel.aspx?modfid=" + iTool.encryptString(DataBinder.Eval(Container.DataItem,"LevelID").ToString()) + "&mode=clone" %>' title="Clone"><img src="images/clone.png" alt="Clone"></a>
									</td>
								</tr>
							</ItemTemplate>
