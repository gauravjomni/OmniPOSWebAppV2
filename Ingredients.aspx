<%@ Page Language="C#"  MasterPageFile="~/innerpage.master" AutoEventWireup="true"  CodeFile="~/Ingredients.aspx.cs" Inherits="PosIng.Ingredients"  %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
			...
			<ul class="shortcut-buttons-set">
				...
				<li><a class="shortcut-button" href="AddIngredient.aspx"><span>
...
--%>				
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
					...
					<h3 style="cursor: s-resize;">Current Ingredient(s)</h3>
					
					<ul class="content-box-tabs">
						<li><a href="#tab1" class="default-tab current">Ingredient Info</a></li> <!-- href must be unique and match the id of target div -->
					...
					<div style="display: block;" class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
					    ...
					    <asp:Literal ID="Msg" runat="server" Visible="false">
						    <div class="notification attention png_bg">
							    ...
							    <div>Permission Denied! This Ingredient Is Already Attached With Any Product . Please Delete That Product First And Then You Can Delete That Ingredient.</div>
						    </div>
					    </asp:Literal>		
                          ...
                          <asp:Repeater ID="IngredientRepeater" runat="server" onitemdatabound="IngredientRepeater_ItemDataBound">
							<HeaderTemplate>
							<tbody>
							</HeaderTemplate>
							<ItemTemplate>
								<tr class="alt-row">
									...
									<td><%# DataBinder.Eval(Container.DataItem, "IngredientName")%></td>
									...
									<td>
										<!-- Icons -->
										 <a href='<%# "AddIngredient.aspx?ingid=" + iTool.encryptString(DataBinder.Eval(Container.DataItem,"IngredientID").ToString()) + "&mode=edit" %>' title="Edit"><img src="images/pencil.png" alt="Edit"></a>
										 <a href="javascript:;" title="Delete" onclick="removerec('<%# iTool.encryptString(DataBinder.Eval(Container.DataItem,"IngredientID").ToString())%>','Ingredients.aspx')"><img src="images/cross.png" alt="Delete"></a>
										 <a href='<%# "AddIngredient.aspx?ingid=" + iTool.encryptString(DataBinder.Eval(Container.DataItem,"IngredientID").ToString()) + "&mode=clone" %>' title="Clone"><img src="images/clone.png" alt="Clone"></a>
									</td>
								</tr>
							</ItemTemplate>
