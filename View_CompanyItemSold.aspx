<%@ Page Language="C#"  MasterPageFile="~/innerpage.master" AutoEventWireup="true"  CodeFile="~/View_CompanyItemSold.aspx.cs" Inherits="PosReport.View_CompanyItemSold"  %>
        ...
        EnableScriptLocalization="true" ID="ScriptManager1" />
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
					...
					<h3 style="cursor: s-resize;">Individual <asp:Literal ID="LblHead" runat="server" Text="Items Sold Report [ For All Locations ]"></asp:Literal></h3>
...
--%>                        
									...
									<table>
							            <thead>
								            <tr style="background-color:#000000; color:#ffffff">
								               <td></td> <td></td><td></td><td></td><td></td><td align="center" style="font-weight:bold">Individual Items Sold Report</td>
								            </tr>
    	        						</thead>
                    ...
                    <asp:Label ID="companyaddress" runat="server" Visible="false"></asp:Label>
                                    ...
                                    <div id = "Product" runat="server" visible="false">
                                      ...
                                      <tr>
                                            <td align="left" style="font-weight:bold">Item Sold Breakdown</td>
                                      </tr>
                                      <tr>
                                        <td align="left">
...
<%--                                            <td width="20%" align="center" style="color:Black;"><%# DataBinder.Eval(Container.DataItem,"TransactionDate")%></td>--%>
                                            ...
                                            <td width="5%" align="center" style="color:Black; font-style:italic;"><asp:Literal ID="Currency" runat="server"></asp:Literal><%# DataBinder.Eval(Container.DataItem,"Amount")%></td>
                                          </tr>
                                          </ItemTemplate>
					            		  <FooterTemplate>
