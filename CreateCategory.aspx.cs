    ...
    public partial class AddCategory : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                {
                    Session["bckurl"] = "CreateCategory.aspx";
        ...
        protected void BtnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                ArParams[7].Value = strCatName2;

                ArParams[8] = new SqlParameter("@SortOrder", SqlDbType.Int);
                ArParams[8].Value = strSortOrder; 
                ...
                if (flag == true)
                {
                    LblGrp.Text = "Category Name already exist. Try with another one.";
                    return;
                }
