<%@ Page Language="C#"  MasterPageFile="~/innerpage.master" AutoEventWireup="true" CodeFile="LocationComparisonReport.aspx.cs" Inherits="LocationComparisonReport" %>
									...
									<table>
							            <thead>
								            <tr style="background-color:#000000; color:#ffffff">
								               <td></td> <td></td><td></td><td></td><td></td><td align="center" style="font-weight:bold">Sales Comparison Report</td>
								            </tr>
    	        						</thead>
                ...
                <asp:Label ID="companyaddress" runat="server" Visible="false"></asp:Label>
                                  ...
                                  <tr>
                                   ...
                                   <table>
							            <thead>
								            <tr style="background-color:#000000; color:#ffffff">
								               <td></td> <td></td><td></td><td></td><td></td><td align="center" style="font-weight:bold">Sales Chart Comparison Report</td>
								            </tr>
    	        						</thead>
    	        					  </table>
                                      <table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
         ...
         <asp:TableRow>
            <asp:TableCell>
                <asp:chart id="Chart1" runat="server" Height="250px" Width="300px">
					...
					<legends>
						<asp:Legend Alignment="Center" Docking="Bottom" IsTextAutoFit="True" Name="LocationComparisonReport" LegendStyle="Row" />
					</legends>
					<series>
						<asp:Series Name="LocationComparisonReport" />
					</series>
					<chartareas>
            ...
            <asp:TableCell>
            <asp:chart id="Chart2" runat="server" Height="250px" Width="300px">
                <Titles>
