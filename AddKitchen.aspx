<%@ Page Language="C#"  MasterPageFile="~/innerpage.master" AutoEventWireup="true"  CodeFile="~/AddKitchen.aspx.cs" Inherits="PosKitchens.AddKitchen"  %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
					...
					<h3 style="cursor: s-resize;"><asp:Literal ID="LblHead" runat="server" Text="Add Kitchen"></asp:Literal></h3>
							...
							<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
								...
								<p>
									<label>Kitchen Name</label>
										<input class="text-input small-input" id="txtKitchenName" name="txtKitchenName" type="text" runat="server" /> 
                                        <asp:RequiredFieldValidator ID="ReqdKitchenName" runat="server" ErrorMessage=" *" ControlToValidate="txtKitchenName"></asp:RequiredFieldValidator>
										<br /><small><asp:Label ID="LblKitchen" runat="server" ForeColor="Red"></asp:Label></small>
								</p>
								...
								<p>
                                    ...
                                    <a href="Kitchens.aspx" class="pageback">Back To Menu</a>
                                        <asp:HiddenField ID="KID" runat="server" Value ="-1" />
