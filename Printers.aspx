<%@ Page Language="C#"  MasterPageFile="~/innerpage.master" AutoEventWireup="true"  CodeFile="~/Printers.aspx.cs" Inherits="PosPrinters.PrinterList"  %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
			...
			<ul class="shortcut-buttons-set">
				...
				<li><a class="shortcut-button" href="AddPrinter.aspx"><span>
...
--%>				
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
					...
					<h3 style="cursor: s-resize;">Current Printer(s)</h3>
					
					<ul class="content-box-tabs">
						<li><a href="#tab1" class="default-tab current">Printer(s)</a></li> <!-- href must be unique and match the id of target div -->
				...
				<div class="content-box-content">
					...
					<asp:Literal ID="Msg" runat="server" Visible="false">
						<div class="notification attention png_bg">
							...
							<div>Permission Denied! This Printer Is Already Attached With Any Product / Device. Please Delete That Product / Device First And Then You Can Delete That Printer .</div>
						</div>
					</asp:Literal>		
		 				 <table>
                          ...
                          <asp:Repeater ID="PrinterRepeater" runat="server" OnItemDataBound="PrinterRepeater_ItemDataBound">
							<HeaderTemplate>
							<tbody>
							</HeaderTemplate>
							<ItemTemplate>
								<tr class="alt-row">
									...
									<td><%# DataBinder.Eval(Container.DataItem,"PrinterName") %></td>
									<td><%# DataBinder.Eval(Container.DataItem,"IPAddress") %></td>
									<td><%# DataBinder.Eval(Container.DataItem, "PrinterType").ToString() == "P" ? "Payment" : "Default" %></td>
									<td><%# DataBinder.Eval(Container.DataItem, "Status").ToString() == "1" ? "<img src=\"images/true.gif\">" : "<img src=\"images/false.gif\">" %></td>
									<td>
										<!-- Icons -->
										 <a href='<%# "AddPrinter.aspx?prnid=" + iTool.encryptString(DataBinder.Eval(Container.DataItem,"PrinterID").ToString()) + "&mode=edit" %>' title="Edit"><img src="images/pencil.png" alt="Edit"></a>
										 <a href="javascript:;" title="Delete" onclick="removerec('<%# iTool.encryptString(DataBinder.Eval(Container.DataItem,"PrinterID").ToString())%>','Printers.aspx')"><img src="images/cross.png" alt="Delete"></a>
										 <a href='<%# "AddPrinter.aspx?prnid=" + iTool.encryptString(DataBinder.Eval(Container.DataItem,"PrinterID").ToString()) + "&mode=clone" %>' title="Clone"><img src="images/clone.png" alt="Clone"></a>
									</td>
								</tr>
							</ItemTemplate>
								...
								<tr>
									...
									<td>
										<!-- Icons -->
										 <a href='<%# "AddPrinter.aspx?prnid=" + iTool.encryptString(DataBinder.Eval(Container.DataItem,"PrinterID").ToString()) + "&mode=edit" %>' title="Edit"><img src="images/pencil.png" alt="Edit"></a>
										 <a href="javascript:;" title="Delete" onclick="removerec('<%# iTool.encryptString(DataBinder.Eval(Container.DataItem,"PrinterID").ToString())%>','Printers.aspx')"><img src="images/cross.png" alt="Delete"></a>
										 <a href='<%# "AddPrinter.aspx?prnid=" + iTool.encryptString(DataBinder.Eval(Container.DataItem,"PrinterID").ToString()) + "&mode=clone" %>' title="Clone"><img src="images/clone.png" alt="Clone"></a>									</td>
								</tr>
							</AlternatingItemTemplate>		
							<FooterTemplate>
							    <tr>
