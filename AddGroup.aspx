<%@ Page Language="C#"  MasterPageFile="~/innerpage.master" AutoEventWireup="true"  CodeFile="~/AddGroup.aspx.cs" Inherits="PosUserGroup.AddGroup"  %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
					...
					<h3 style="cursor: s-resize;"><asp:Literal ID="LblHead" runat="server" Text="Add User Group"></asp:Literal></h3>
							...
							<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
								...
								<p>
									<label>Group Name</label>
										<input class="text-input small-input" id="txtGroupName" name="txtGroupName" type="text" runat="server" /> 
                                        <asp:RequiredFieldValidator ID="ReqdGrpName" runat="server" ErrorMessage="Please Enter Group Name" ControlToValidate="txtGroupName"></asp:RequiredFieldValidator>
								...
								<p>
                                    ...
                                    <a href="UserGroups.aspx" class="pageback">Back To Menu</a>
