<%@ Page Language="C#"  MasterPageFile="~/innerpage.master" AutoEventWireup="true"  CodeFile="~/AddInstruction.aspx.cs" Inherits="PosInstruction.AddInstruction"  %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
					...
					<h3 style="cursor: s-resize;"><asp:Literal ID="LblHead" runat="server" Text="Special Instruction For Kitchen"></asp:Literal></h3>
							...
							<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
								...
								<asp:Panel ID="Panel" runat="server" Visible="false">
                                    <div class="notification attention png_bg">
							            ...
							            <div>Instruction updated successfully.</div>
						                </div>
						        </asp:Panel>
								<p>
									<label>Message</label>
										<textarea class="textarea medium-textarea" id="txtMessage" runat="server" /> 
                                        <asp:RequiredFieldValidator ID="ReqdMessage" runat="server" ErrorMessage=" *" ControlToValidate="txtMessage"></asp:RequiredFieldValidator>
								</p>
								...
								<p>
                                    ...
                                    <asp:HiddenField ID="InstructionID" runat="server" Value="-1" />
