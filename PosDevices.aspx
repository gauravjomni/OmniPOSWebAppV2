<%@ Page Language="C#"  MasterPageFile="~/innerpage.master" AutoEventWireup="true"  CodeFile="~/PosDevices.aspx.cs" Inherits="PosDevice.PosDevices"  %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
			...
			<ul class="shortcut-buttons-set">
				...
				<li><a class="shortcut-button" href="AddPosDevice.aspx"><span>
...
--%>				
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
					...
					<h3 style="cursor: s-resize;">Current Device(s)</h3>
					
					<ul class="content-box-tabs">
						<li><a href="#tab1" class="default-tab current">Device Info</a></li> <!-- href must be unique and match the id of target div -->
...
the way, you can close this notification with the top-right cross.							</div>
                          ...
                          <asp:Repeater ID="DeviceInfoRepeater" runat="server" OnItemDataBound="DeviceInfoRepeater_ItemDataBound">
							<HeaderTemplate>
							<tbody>
							</HeaderTemplate>
							<ItemTemplate>
								<tr class="alt-row">
									...
									<td>
										<!-- Icons -->
										 <a href='<%# "AddPosDevice.aspx?dvid=" + iTool.encryptString(DataBinder.Eval(Container.DataItem,"DeviceID").ToString()) + "&mode=edit" %>' title="Edit"><img src="images/pencil.png" alt="Edit"></a>
										 <a href="javascript:;" title="Delete" onclick="removerec('<%# iTool.encryptString(DataBinder.Eval(Container.DataItem,"DeviceID").ToString())%>','PosDevices.aspx')"><img src="images/cross.png" alt="Delete"></a>
										 <a href='<%# "AddPosDevice.aspx?dvid=" + iTool.encryptString(DataBinder.Eval(Container.DataItem,"DeviceID").ToString()) + "&mode=clone" %>' title="Clone"><img src="images/clone.png" alt="Clone"></a>
									</td>
								</tr>
							</ItemTemplate>
