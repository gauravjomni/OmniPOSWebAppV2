<%@ Page Language="C#"  MasterPageFile="~/innerpage.master" AutoEventWireup="true"  CodeFile="~/AddModifierLevel.aspx.cs" Inherits="PosModifiers.AddModifierLevel"  %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
					...
					<h3 style="cursor: s-resize;"><asp:Literal ID="LblHead" runat="server" Text="Add Modifier Level"></asp:Literal></h3>
				...
				<div class="content-box-content">
					<div id="Form">
							...
							<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
								...
								<p>
									<label>Modifier Level Name</label>
										<input class="text-input small-input" id="txtModLevelName" type="text" runat="server" /> 
                                        <asp:RequiredFieldValidator ID="ReqdModLevelName" runat="server" ErrorMessage=" *" ControlToValidate="txtModLevelName"></asp:RequiredFieldValidator>
								...
								<p>
                                    ...
                                    <a href="Modifierlevel.aspx" class="pageback">Back To Menu</a>
                                        <asp:HiddenField ID="ModLevelID" runat="server" Value ="-1" />
