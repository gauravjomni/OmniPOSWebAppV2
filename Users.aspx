<%@ Page Language="C#" MasterPageFile="~/innerpage.master" AutoEventWireup="true"
    CodeFile="~/Users.aspx.cs" Inherits="PosUsers.Users" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="main-content">
        ...
        <ul class="shortcut-buttons-set">
            <li><a class="shortcut-button" href="AddUser.aspx"><span>
        ...
        <div class="content-box">
            ...
            <div class="content-box-header">
                ...
                <ul class="content-box-tabs">
                    <li><a href="#tab1" class="default-tab current">User(s)</a></li>
                        ...
                        <asp:Repeater ID="UserRepeater" runat="server">
                            ...
                            <itemtemplate>
								<tr class="alt-row">
									...
									<td><%# DataBinder.Eval(Container.DataItem,"RestName") %></td>
									<td>
										<!-- Icons -->
										 <a href='<%# "AddUser.aspx?usrid=" + iTool.encryptString(DataBinder.Eval(Container.DataItem,"UserID").ToString()) + "&mode=edit" %>' title="Edit"><img src="images/pencil.png" alt="Edit"></a>
<%--										 <a href="javascript:;" title="Delete" onclick="removerec('<%# iTool.encryptString(DataBinder.Eval(Container.DataItem,"UserID").ToString())%>','Users.aspx')"><img src="images/cross.png" alt="Delete"></a>--%>
										 <a href='<%# "AddUser.aspx?usrid=" + iTool.encryptString(DataBinder.Eval(Container.DataItem,"UserID").ToString()) + "&mode=clone" %>' title="Clone"><img src="images/clone.png" alt="Clone"></a>
									 </td>
								</tr>
							</itemtemplate>
