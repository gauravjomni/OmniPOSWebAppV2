<%@ Page Language="C#"  MasterPageFile="~/innerpage.master" AutoEventWireup="true"  CodeFile="~/CreateSubCategory.aspx.cs" Inherits="PosCategory.AddSubCategory"  %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
					...
					<h3 style="cursor: s-resize;"><asp:Literal ID="LblHead" runat="server" Text="Add Subcategory"></asp:Literal></h3>
							...
							<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
								...
								<p>
									<label>SubCategory Name</label>
										<input class="text-input small-input" id="txtCatName" name="txtCatName" type="text" runat="server" /> 
                                        <asp:RequiredFieldValidator ID="ReqdCatName" runat="server" ErrorMessage=" *" ControlToValidate="txtCatName"></asp:RequiredFieldValidator>
										<br /><small><asp:Label ID="LblGrp" runat="server" ForeColor="Red"></asp:Label></small>
								</p>
								
								<p>
									<label>Name2</label>
										<input class="text-input small-input" id="txtCatName2" type="text" runat="server" /> 
								</p>

								<p>
									<label>Sort Order</label>
										<input class="text-input xx_small-input" id="txtSort" name="txtSort" type="text" runat="server" /> 
								...
								<p>
									<label>Choose Parent Category</label>
    									<asp:DropDownList ID="ParentCategory" runat="server" AutoPostBack="false" CssClass="login-inp_lb"></asp:DropDownList>
                                        <asp:RequiredFieldValidator ID="ReqdParentCategory" runat="server" ErrorMessage=" *" ControlToValidate="ParentCategory"></asp:RequiredFieldValidator>
								</p>
								...
								<p>
                                    ...
                                    <a href="Categories.aspx" class="pageback">Back To Menu</a>
                                        <asp:HiddenField ID="CatID" runat="server" Value ="-1" />
