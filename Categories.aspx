<%@ Page Language="C#"  MasterPageFile="~/innerpage.master" AutoEventWireup="true"  CodeFile="~/Categories.aspx.cs" Inherits="PosCategory.Categories"  %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
			...
			<ul class="shortcut-buttons-set">
				...
				<li><a class="shortcut-button" href="CreateCategory.aspx"><span>
					<img src="images/pencil_48.png" alt="icon"><br>
					Add Category
				</span></a></li>
				
				<li><a class="shortcut-button" href="CreateSubCategory.aspx"><span>
					<img src="images/pencil_48.png" alt="icon"><br>
					Add SubCategory
				</span></a></li>

<%--				<li><a class="shortcut-button" href="Categories.aspx"><span>
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
					...
					<h3 style="cursor: s-resize;">Current Category(s) / Sub Category(s)</h3>
					
					<ul class="content-box-tabs">
						<li><a href="#tab1" class="default-tab current">Categories(s)</a></li> <!-- href must be unique and match the id of target div -->
				...
				<div class="content-box-content">
					...
					<asp:Literal ID="Msg" runat="server" Visible="false">
						<div class="notification attention png_bg">
							...
							<div>Permission Denied! This Category / SubCategory Is Already Attached With Any Product . Please Delete That Product First And Then You Can Delete That Category / SubCategory.</div>
						</div>
					</asp:Literal>		
                          ...
                          <asp:Repeater ID="CategoryRepeater" runat="server" OnItemDataBound="CategoryRepeater_ItemDataBound">
							...
							<ItemTemplate>
								<tr class="alt-row">
									...
									<td>
										<!-- Icons -->
										 <a href='<%# DataBinder.Eval(Container.DataItem,"URL") + "?catid=" + iTool.encryptString(DataBinder.Eval(Container.DataItem,"CategoryID").ToString()) + "&mode=edit" %>' title="Edit"><img src="images/pencil.png" alt="Edit"></a>
										 <a href="javascript:;" title="Delete" onclick="removerec('<%# iTool.encryptString(DataBinder.Eval(Container.DataItem,"CategoryID").ToString())%>','Categories.aspx')"><img src="images/cross.png" alt="Delete"></a>
										 <a href='<%# DataBinder.Eval(Container.DataItem,"URL") + "?catid=" + iTool.encryptString(DataBinder.Eval(Container.DataItem,"CategoryID").ToString()) + "&mode=clone" %>' title="Clone"><img src="images/clone.png" alt="Clone"></a> 
									</td>
								</tr>
							</ItemTemplate>
