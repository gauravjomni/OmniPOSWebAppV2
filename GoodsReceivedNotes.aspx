<%@ Page Language="C#"  MasterPageFile="~/innerpage.master" AutoEventWireup="true"  CodeFile="~/GoodsReceivedNotes.aspx.cs" Inherits="PosInventory.GoodsReceivedNotes" enableSessionState="true" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
			...
			<ul class="shortcut-buttons-set">
				...
				<li><a class="shortcut-button" href="AddGoodsReceiveNote.aspx"><span>
...
--%>				
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
					...
					<h3 style="cursor: s-resize;">List Of GRN(s)</h3>
							
					<ul class="content-box-tabs">
						<li><a href="#tab1" class="default-tab current">Goods Received Note(s)</a></li> <!-- href must be unique and match the id of target div -->
...
the way, you can close this notification with the top-right cross.							</div>
						  ...
						  <br />
                          <asp:Repeater ID="GRNRepeater" runat="server" OnItemDataBound="GRNRepeater_ItemDataBound">
							<HeaderTemplate>
							<tbody>
							</HeaderTemplate>
							<ItemTemplate>
								<tr class="alt-row">
									...
									<td style="font-size:12px"><%# DataBinder.Eval(Container.DataItem,"Tran_Code") %></td>
									<td style="font-size:12px"><%# String.Format("{0:MM/dd/yyyy}",DataBinder.Eval(Container.DataItem,"Tran_Date")) %></td>
									...
									<td style="font-size:12px"><%# DataBinder.Eval(Container.DataItem, "IsFullPaid").ToString() == "True" ? "<img src=\"images/true.gif\">" : "<img src=\"images/cross.png\">"%></td>
									<td style="font-size:12px">
										<!-- Icons -->
										 <a href='<%# "AddGoodsReceiveNote.aspx?grnid=" + iTool.encryptString(DataBinder.Eval(Container.DataItem,"GRNNO").ToString()) + "&mode=edit" %>' title="Edit"><img src="images/pencil.png" alt="Edit"></a>
                                         <%--<a href="javascript:;" title="Delete" onclick="removerec('<%# iTool.encryptString(DataBinder.Eval(Container.DataItem,"GRNNO").ToString())%>','GoodsReceivedNotes.aspx')"><img src="images/cross.png" alt="Delete"></a>--%>
										 <a href='<%# "AddGoodsReceiveNote.aspx?grnid=" + iTool.encryptString(DataBinder.Eval(Container.DataItem,"GRNNO").ToString()) + "&mode=clone" %>' title="Clone"><img src="images/clone.png" alt="Clone"></a>
                                     </td>
								</tr>
							</ItemTemplate>
