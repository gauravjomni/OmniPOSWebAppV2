<%@ Page Language="C#"  MasterPageFile="~/innerpage.master" AutoEventWireup="true"  CodeFile="~/AddCourse.aspx.cs" Inherits="PosCourse.AddCourse"  %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <uc_head:header_Ctrl ID="Header_Ctrl" runat="server" />
				...
				<li><a class="shortcut-button" href="Courses.aspx"><span>
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
					...
					<h3 style="cursor: s-resize;"><asp:Literal ID="LblHead" runat="server" Text="Add Course"></asp:Literal></h3>
							...
							<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
								...
								<p>
									<label>Course Name</label>
										<input class="text-input small-input" id="txtcourseName" type="text" runat="server" /> 
                                        <asp:RequiredFieldValidator ID="ReqdCourseName" runat="server" ErrorMessage=" *" ControlToValidate="txtcourseName"></asp:RequiredFieldValidator>
										<br /><small><asp:Label ID="LblCourse" runat="server" ForeColor="Red"></asp:Label></small>
								</p>
								...
								<p>
                                    ...
                                    <a href="Courses.aspx" class="pageback">Back To Menu</a>
                                        <asp:HiddenField ID="CourseID" runat="server" Value ="-1" />
