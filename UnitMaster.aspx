<%@ Page Language="C#"  MasterPageFile="~/innerpage.master" AutoEventWireup="true"  CodeFile="~/UnitMaster.aspx.cs" Inherits="PosUnit.UnitMaster"  %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
			...
			<ul class="shortcut-buttons-set">
				...
				<li><a class="shortcut-button" href="AddUnit.aspx"><span>
...
--%>				
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
					...
					<h3 style="cursor: s-resize;">Current Unit(s)</h3>
					
					<ul class="content-box-tabs">
						<li><a href="#tab1" class="default-tab current">Unit(s)</a></li> <!-- href must be unique and match the id of target div -->
				...
				<div class="content-box-content">
					...
					<asp:Literal ID="Msg" runat="server" Visible="false">
						<div class="notification attention png_bg">
							...
							<div>Permission Denied! This Unit Is Already Assigned With Any Product / Sub Recipe / Ingredient. Please Delete That Product / Ingredient First And Then You Can Delete That Unit .</div>
						</div>
					</asp:Literal>		
		 				 <table>
                          ...
                          <asp:Repeater ID="UnitRepeater" runat="server" OnItemDataBound="UnitRepeater_ItemDataBound">
							<HeaderTemplate>
							<tbody>
							</HeaderTemplate>
							<ItemTemplate>
								<tr class="alt-row">
									...
									<td>
										<!-- Icons -->
										 <a href='<%# "AddUnit.aspx?unitid=" + iTool.encryptString(DataBinder.Eval(Container.DataItem,"UnitID").ToString()) + "&mode=edit" %>' title="Edit"><img src="images/pencil.png" alt="Edit"></a>
										 <a href="javascript:;" title="Delete" onclick="removerec('<%# iTool.encryptString(DataBinder.Eval(Container.DataItem,"UnitID").ToString())%>','UnitMaster.aspx')"><img src="images/cross.png" alt="Delete"></a>
										 <a href='<%# "AddUnit.aspx?unitid=" + iTool.encryptString(DataBinder.Eval(Container.DataItem,"UnitID").ToString()) + "&mode=clone" %>' title="Clone"><img src="images/clone.png" alt="Clone"></a>
									</td>
								</tr>
							</ItemTemplate>
								...
								<tr>
									...
									<td>
										<!-- Icons -->
										 <a href='<%# "AddUnit.aspx?unitid=" + iTool.encryptString(DataBinder.Eval(Container.DataItem,"UnitID").ToString()) + "&mode=edit" %>' title="Edit"><img src="images/pencil.png" alt="Edit"></a>
										 <a href="javascript:;" title="Delete" onclick="removerec('<%# iTool.encryptString(DataBinder.Eval(Container.DataItem,"UnitID").ToString())%>','UnitMaster.aspx')"><img src="images/cross.png" alt="Delete"></a>
										 <a href='<%# "AddUnit.aspx?unitid=" + iTool.encryptString(DataBinder.Eval(Container.DataItem,"UnitID").ToString()) + "&mode=clone" %>' title="Clone"><img src="images/clone.png" alt="Clone"></a>									</td>
								</tr>
							</AlternatingItemTemplate>		
							<FooterTemplate>
							    <tr>
