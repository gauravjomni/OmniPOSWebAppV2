<%@ Page Language="C#"  MasterPageFile="~/innerpage.master" AutoEventWireup="true"  CodeFile="~/zreport_company.aspx.cs" Inherits="PosReport.zreport"  %>
        ...
        EnableScriptLocalization="true" ID="ScriptManager1" />
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
					...
					<h3 style="cursor: s-resize;">Generate <asp:Literal ID="LblHead" runat="server" Text="Z-Report (Company)"></asp:Literal></h3>
									...
									<table>
							            <thead>
								            <tr style="background-color:#000000; color:#ffffff">
								               <th align="center">Z-Report (Company)</th>
								            </tr>
    	        						</thead>
                                      ...
                                      <tr>
                                        ...
                                        <%--<div id = "Employees" runat="server" visible="false">--%>
                                          ...
                                          <tr style="background:#EAF9FF" >
                                            ...
                                            <td align="center" style="color:Black; font-style:italic;font-weight:bold;"><%# StrCurrency + DataBinder.Eval(Container.DataItem, "Employee")%></td>
                                          </tr>
