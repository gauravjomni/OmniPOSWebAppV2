<%@ Page Language="C#"  MasterPageFile="~/innerpage.master" AutoEventWireup="true"  CodeFile="~/AddState.aspx.cs" Inherits="PosState.AddState"  %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <uc_head:header_Ctrl ID="Header_Ctrl" runat="server" />
				...
				<li><a class="shortcut-button" href="States.aspx"><span>
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
					...
					<h3 style="cursor: s-resize;"><asp:Literal ID="LblHead" runat="server" Text="Add State"></asp:Literal></h3>
							...
							<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
								...
								<p>
									<label>State Name</label>
										<input class="text-input small-input" id="txtStateName" type="text" runat="server" /> 
                                        <asp:RequiredFieldValidator ID="ReqdStateName" runat="server" ErrorMessage=" *" ControlToValidate="txtStateName"></asp:RequiredFieldValidator>
								...
								<p>
                                    ...
                                    <a href="States.aspx" class="pageback">Back To Menu</a>
                                        <asp:HiddenField ID="StateID" runat="server" Value ="-1" />
