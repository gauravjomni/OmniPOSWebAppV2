<%@ Page Language="C#"  MasterPageFile="~/innerpage.master" AutoEventWireup="true"  CodeFile="~/Instruction.aspx.cs" Inherits="PosInstruction.Instruction"  %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
			...
			<ul class="shortcut-buttons-set">
				...
				<li><a class="shortcut-button" href="AddInstruction.aspx"><span>
...
--%>				
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
					...
					<h3 style="cursor: s-resize;">Current Instruction(s)</h3>
					
					<ul class="content-box-tabs">
						<li><a href="#tab1" class="default-tab current">Instruction(s)</a></li> <!-- href must be unique and match the id of target div -->
				...
				<div class="content-box-content">
					...
					<div style="display: block;" class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
                          ...
                          <asp:Repeater ID="InstructionRepeater" runat="server" OnItemDataBound="InstructionRepeater_ItemDataBound">
							<HeaderTemplate>
							<tbody>
							</HeaderTemplate>
							<ItemTemplate>
								<tr class="alt-row">
									...
									<td>
										<!-- Icons -->
										 <a href='<%# "AddInstruction.aspx?insid=" + iTool.encryptString(DataBinder.Eval(Container.DataItem,"InstructionID").ToString()) + "&mode=edit" %>' title="Edit"><img src="images/pencil.png" alt="Edit"></a>
										 <a href="javascript:;" title="Delete" onclick="removerec('<%# iTool.encryptString(DataBinder.Eval(Container.DataItem,"InstructionID").ToString())%>','Instruction.aspx')"><img src="images/cross.png" alt="Delete"></a>
                                         <a href='<%# "AddInstruction.aspx?insid=" + iTool.encryptString(DataBinder.Eval(Container.DataItem,"InstructionID").ToString()) + "&mode=clone" %>' title="Clone"><img src="images/clone.png" alt="Clone"></a>										 
									</td>
								</tr>
							</ItemTemplate>
