...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
					...
					<h3 style="cursor: s-resize;">User Notification</h3>
				...
				<div class="content-box-content">
                	...
                	<div style="display: block;" class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
						...
						<div class="notification error png_bg">
							...
							<div><h5>Error in opening since you did not select any location. <a href="Select_Restaurants.aspx"> [ Select Location ]</a></h5></div>
						</div>
