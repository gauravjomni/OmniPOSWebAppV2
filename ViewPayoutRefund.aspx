<%@ Page Language="C#"  MasterPageFile="~/innerpage.master" AutoEventWireup="true"  CodeFile="~/ViewPayoutRefund.aspx.cs" Inherits="PosReport.ViewPayoutRefund"  %>
        ...
        EnableScriptLocalization="true" ID="ScriptManager1" />
			...
			<div class="content-box"><!-- Start Content Box -->
				<div class="content-box-header">
					...
					<h3 style="cursor: s-resize;">Payouts and Refunds [ <%= Session["R_Name"].ToString()%> ]</h3>
									...
									<table style="font-size:12px;">
						            	...
						            	<ItemTemplate>
								            <tr class="alt-row">
									            ...
									            <td style="text-align:right; padding-right:25px;"><%# StrCurrency + DataBinder.Eval(Container.DataItem, String.Format("{0:00}", "Amount"))%></td>
