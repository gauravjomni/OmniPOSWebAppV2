<%@ Page Language="C#" MasterPageFile="~/innerpage.master" AutoEventWireup="true" CodeFile="UserAttendancePage.aspx.cs" Inherits="UserAttendancePage" %>
        ...
        EnableScriptLocalization="true" ID="ScriptManager1" />
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
					...
					<h3 style="cursor: s-resize;"><asp:Literal ID="LblHead" runat="server" Text="User Attendence Page"></asp:Literal></h3>
									...
									<table>
							            <thead>
								            <tr style="background-color:#000000; color:#ffffff">
								               <td></td> <td></td><td></td><td></td><td></td><td align="center" style="font-weight:bold">User Attendence Report</td>
								            </tr>
    	        						</thead>
                                  ...
                                  <tr>
                                      ...
                                      <tr>
                                        ...
                                        <div id = "z_report" runat="server" visible="false">
                                          ...
                                          <asp:TableRow>
                                          <asp:TableCell Font-Bold="true">Login Time</asp:TableCell>
                                          <asp:TableCell Font-Bold="true">Logout Time</asp:TableCell>
                                          <asp:TableCell Font-Bold="true">Duration</asp:TableCell>
                                          <asp:TableCell Font-Bold="true">Total Rate</asp:TableCell>
                                          </asp:TableRow>
                                           </asp:Table>
                                        </div> 
                                        </td>
