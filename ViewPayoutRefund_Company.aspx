<%@ Page Language="C#"  MasterPageFile="~/innerpage.master" AutoEventWireup="true"  CodeFile="~/ViewPayoutRefund_Company.aspx.cs" Inherits="PosReport.ViewPayoutRefund_Company"  %>
        ...
        EnableScriptLocalization="true" ID="ScriptManager1" />
			...
			<div class="content-box"><!-- Start Content Box -->
				<div class="content-box-header">
					...
					<h3 style="cursor: s-resize;">Payouts and Refunds [ For All Locations ]</h3>
                ...
                <asp:Label ID="companyaddress" runat="server" Visible="false"></asp:Label>
								...
								<div style="width:650px; font-size:12px;">
									<table style=" font-size:12px;">
    	        					    ...
    	        					    <asp:Repeater ID="PayoutRefundTranHistoryRepeater" runat="server" OnItemDataBound="PayoutRefundTranHistoryRepeater_ItemDataBound">
							            <HeaderTemplate>
							            <tbody>
							            </HeaderTemplate>
						            	<ItemTemplate>
								            <tr class="alt-row">
									            <td><%# DataBinder.Eval(Container.DataItem,"TransactionID") %></td>
									            <td><%# DataBinder.Eval(Container.DataItem,"TransactDate") %></td>
                                                <td><%# DataBinder.Eval(Container.DataItem,"Name") %></td>
									            <td><%# DataBinder.Eval(Container.DataItem, "DeviceName")%></td>
									            <td><%# DataBinder.Eval(Container.DataItem, "PaymentType")%></td>
									            <td style="text-align:right; padding-right:25px;"><% Response.Write(StrCurrency); %><%# DataBinder.Eval(Container.DataItem, String.Format("{0:00}", "Amount")) %></td>
