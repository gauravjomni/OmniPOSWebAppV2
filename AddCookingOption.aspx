<%@ Page Language="C#"  MasterPageFile="~/innerpage.master" AutoEventWireup="true"  CodeFile="~/AddCookingOption.aspx.cs" Inherits="PosOptions.AddCookingOption"  %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
			...
			<ul class="shortcut-buttons-set">
				...
				<li><a class="shortcut-button" href="Options.aspx"><span>
					<img src="images/paper_content_pencil_48.png" alt="icon"><br>
					View Cooking Option(s)
				</span></a></li>
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
					...
					<h3 style="cursor: s-resize;"><asp:Literal ID="LblHead" runat="server" Text="Add Cooking Option"></asp:Literal></h3>
							...
							<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
								...
								<p>
									<label>Option Name</label>
										<input class="text-input small-input" id="txtOptionName" type="text" runat="server" /> 
                                        <asp:RequiredFieldValidator ID="ReqdOptionName" runat="server" ErrorMessage=" *" ControlToValidate="txtOptionName"></asp:RequiredFieldValidator>
										<br /><small><asp:Label ID="LblOption" runat="server" ForeColor="Red"></asp:Label></small>
								</p>
								...
								<p>
                                    ...
                                    <a href="Options.aspx" class="pageback">Back To Menu</a>
                                        <asp:HiddenField ID="OPID" runat="server" Value ="-1" />
