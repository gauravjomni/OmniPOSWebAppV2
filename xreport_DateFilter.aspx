<%@ Page Language="C#"  MasterPageFile="~/innerpage.master" AutoEventWireup="true"  CodeFile="~/xreport_DateFilter.aspx.cs" Inherits="PosReport.xreport_DateFilter"  %>
        ...
        EnableScriptLocalization="true" ID="ScriptManager1" />
			...
			<div class="content-box"><!-- Start Content Box -->
				<div class="content-box-header">
					...
					<h3 style="cursor: s-resize;">Generate <asp:Literal ID="LblHead" runat="server" Text="X-Report"></asp:Literal></h3>
