<%@ Page Language="C#"  MasterPageFile="~/innerpage.master" AutoEventWireup="true"  CodeFile="~/ViewSupplier.aspx.cs" Inherits="PosApp.ViewSupplier"  %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
			...
			<ul class="shortcut-buttons-set">
				...
				<li><a class="shortcut-button" href="AddSupplier.aspx"><span>
...
--%>				
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
					...
					<h3 style="cursor: s-resize;">Current Supplier(s)</h3>
					
					<ul class="content-box-tabs">
						<li><a href="#tab1" class="default-tab current">Supplier(s)</a></li> <!-- href must be unique and match the id of target div -->
				...
				<div class="content-box-content">
					...
					<asp:Literal ID="Msg" runat="server" Visible="false">
						<div class="notification attention png_bg">
							...
							<div>Permission Denied! This State Is Already Attached With Any Location(Restaurant). Please Delete That Location(Restaurant) First And Then You Can Delete That State .</div>
						</div>
					</asp:Literal>		
                          ...
                          <asp:Repeater ID="SupplierRepeater" runat="server" OnItemDataBound="SupplierRepeater_ItemDataBound">
							<HeaderTemplate>
							<tbody>
							</HeaderTemplate>
							<ItemTemplate>
								<tr class="alt-row">
									...
									<td><%# DataBinder.Eval(Container.DataItem,"SupplierName") %></td>
									...
									<td>
										<!-- Icons -->
										 <a href='<%# "AddSupplier.aspx?spid=" + iTool.encryptString(DataBinder.Eval(Container.DataItem,"SupplierID").ToString()) + "&mode=edit" %>' title="Edit"><img src="images/pencil.png" alt="Edit"></a>
                                         <a href="javascript:;" title="Delete" onclick="removerec('<%# iTool.encryptString(DataBinder.Eval(Container.DataItem,"SupplierID").ToString())%>','ViewSupplier.aspx')"><img src="images/cross.png" alt="Delete"></a>
									</td>
								</tr>
							</ItemTemplate>
