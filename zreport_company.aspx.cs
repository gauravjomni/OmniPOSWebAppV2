...
*/
                            ...
                            dict = new Dictionary<string, string>() { { "Rest_ID", "0" } };

                            SqlDataReader LastZReportTranDateRdr = SqlHelper.ExecuteReader(trans, CommandType.Text, Qry.GetLastUpdatesSQL(null,"ZReport_Company"));
                                    ...
                                    for (int i = 0; i < ordprodmodifierids.Length; i++)
                                    {
                                        ...
                                        if (ordprodmodifierid != "" && ordprodmodifierid != null)
                                        {
                                            ...
                                            if (modifiername != "" && modifiername != null)
                                            {
                                                ...
                                                msg += "<td align=\"center\" style=\"color:Black; font-style:italic;\">" + StrCurrency + ordamt + "</td>";
                                                msg += "</tr>";
                                            }
                                        }
                                    }
                            ...
                            ArParams[0].Value = "ZReport_Company";
