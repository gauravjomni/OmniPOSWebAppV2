<%@ Page Language="C#"  MasterPageFile="~/innerpage.master" AutoEventWireup="true"  CodeFile="~/Courses.aspx.cs" Inherits="PosCourse.Courses"  %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
			...
			<ul class="shortcut-buttons-set">
				...
				<li><a class="shortcut-button" href="AddCourse.aspx"><span>
...
--%>				
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
					...
					<h3 style="cursor: s-resize;">Current Course(s)</h3>
					
					<ul class="content-box-tabs">
						<li><a href="#tab1" class="default-tab current">Course(s)</a></li> <!-- href must be unique and match the id of target div -->
				...
				<div class="content-box-content">
					...
					<asp:Literal ID="Msg" runat="server" Visible="false">
						<div class="notification attention png_bg">
							...
							<div>Permission Denied! This Course Is Already Attached With Any Product. Please Delete That Product First And Then You Can Delete That Course.</div>
						</div>
					</asp:Literal>		
                          ...
                          <asp:Repeater ID="CourseRepeater" runat="server" OnItemDataBound="CourseRepeater_ItemDataBound">
							...
							<ItemTemplate>
								<tr class="alt-row">
									...
									<td>
										<!-- Icons -->
										 <a href='<%# "AddCourse.aspx?courseid=" + iTool.encryptString(DataBinder.Eval(Container.DataItem,"CourseID").ToString()) + "&mode=edit" %>' title="Edit"><img src="images/pencil.png" alt="Edit"></a>
										 <a href="javascript:;" title="Delete" onclick="removerec('<%# iTool.encryptString(DataBinder.Eval(Container.DataItem,"CourseID").ToString())%>','Courses.aspx')"><img src="images/cross.png" alt="Delete"></a>
										 <a href='<%# "AddCourse.aspx?courseid=" + iTool.encryptString(DataBinder.Eval(Container.DataItem,"CourseID").ToString()) + "&mode=clone" %>' title="Clone"><img src="images/clone.png" alt="Clone"></a>
									</td>
								</tr>
							</ItemTemplate>
