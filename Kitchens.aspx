<%@ Page Language="C#"  MasterPageFile="~/innerpage.master" AutoEventWireup="true"  CodeFile="~/Kitchens.aspx.cs" Inherits="PosKitchens.KitchenList"  %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
			...
			<ul class="shortcut-buttons-set">
				...
				<li><a class="shortcut-button" href="AddKitchen.aspx"><span>
...
--%>				
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
					...
					<h3 style="cursor: s-resize;">Current Kitchen(s)</h3>
					
					<ul class="content-box-tabs">
						<li><a href="#tab1" class="default-tab current">Kitchen(s)</a></li> <!-- href must be unique and match the id of target div -->
					...
					<div style="display: block;" class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
					    ...
					    <asp:Literal ID="Msg" runat="server" Visible="false">
						    <div class="notification attention png_bg">
							    ...
							    <div>Permission Denied! This Kitchen Is Already Attached With Any Product. Please Delete That Product First And Then You Can Delete That Kitchen.</div>
						    </div>
					    </asp:Literal>		
                          ...
                          <asp:Repeater ID="KitchenRepeater" runat="server" OnItemDataBound="KitchenRepeater_ItemDataBound">
							<HeaderTemplate>
							<tbody>
							</HeaderTemplate>
							<ItemTemplate>
								<tr class="alt-row">
									...
									<td><%# DataBinder.Eval(Container.DataItem,"KitchenName") %></td>
									<td><%# DataBinder.Eval(Container.DataItem, "Status").ToString() == "1" ? "<img src=\"images/true.gif\">" : "<img src=\"images/false.gif\">" %></td>
									<td>
										<!-- Icons -->
										 <a href='<%# "AddKitchen.aspx?kid=" + iTool.encryptString(DataBinder.Eval(Container.DataItem,"KitchenID").ToString()) + "&mode=edit" %>' title="Edit"><img src="images/pencil.png" alt="Edit"></a>
										 <a href="javascript:;" title="Delete" onclick="removerec('<%# iTool.encryptString(DataBinder.Eval(Container.DataItem,"KitchenID").ToString())%>','Kitchens.aspx')"><img src="images/cross.png" alt="Delete"></a>
										 <a href='<%# "AddKitchen.aspx?kid=" + iTool.encryptString(DataBinder.Eval(Container.DataItem,"KitchenID").ToString()) + "&mode=clone" %>' title="Clone"><img src="images/clone.png" alt="Clone"></a>
									</td>
								</tr>
							</ItemTemplate>
								...
								<tr>
									...
									<td>
										<!-- Icons -->
										 <a href='<%# "AddKitchen.aspx?kid=" + iTool.encryptString(DataBinder.Eval(Container.DataItem,"KitchenID").ToString()) + "&mode=edit" %>' title="Edit"><img src="images/pencil.png" alt="Edit"></a>
										 <a href="javascript:;" title="Delete" onclick="removerec('<%# iTool.encryptString(DataBinder.Eval(Container.DataItem,"KitchenID").ToString())%>','Kitchens.aspx')"><img src="images/cross.png" alt="Delete"></a>
										 <a href='<%# "AddKitchen.aspx?kid=" + iTool.encryptString(DataBinder.Eval(Container.DataItem,"KitchenID").ToString()) + "&mode=clone" %>' title="Clone"><img src="images/clone.png" alt="Clone"></a>									</td>
								</tr>
							</AlternatingItemTemplate>		
							<FooterTemplate>
							    <tr>
