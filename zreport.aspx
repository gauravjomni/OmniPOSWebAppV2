<%@ Page Language="C#"  MasterPageFile="~/innerpage.master" AutoEventWireup="true"  CodeFile="~/zreport.aspx.cs" Inherits="PosReport.zreport"  %>
...
<%--                                <p>
                                ...
                                <p>
                                <asp:Button ID="BtnSave" runat="server" Text="Generate Report" CssClass="button" 
								...
								<div  style="float:left; width:650px;">
									...
									<table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
                                      <tr>
                                        <td align="left" style="font-weight:bold">Today Is :&nbsp; <%=String.Format("{0:dd/MM/yyyy HH:mm:ss}", CurrDateTime)%></td>
                                  </tr>
                                  <tr>
                                      ...
                                      <tr>
                                        ...
                                        <div id = "z_report" runat="server" visible="false">
                                          ...
                                          <tr>
                                            <td align="left" style="color:Black;">Cash Sale</td>
...
--%>                                        </table>
                                      ...
                                      <tr>
                                        ...
                                        <%--<div id = "Employees" runat="server" visible="false">--%>
                                          ...
                                          <tr>
                                            ...
                                            <td align="center" style="color:Black; background:white; font-style:italic;"><%# StrCurrency + DataBinder.Eval(Container.DataItem,"CashSale")%></td>
                                          </tr>
                                          <tr>
                                            <td align="left" style="color:Black;">Card Sale</td>
                                            <td align="center" style="color:Black;font-style:italic;"><%# StrCurrency + DataBinder.Eval(Container.DataItem,"CardSale") %></td>
                                          </tr>
                                          <tr>
                                            <td align="left" style="color:Black; background:white;">Voucher Sale</td>
                                            <td align="center" style="color:Black; background:white;font-style:italic;"><%# StrCurrency + DataBinder.Eval(Container.DataItem, "VoucherSale")%></td>
                                          </tr>
                                            <tr>
                                                <td align="left" style="color:Black; font-weight:bold">Total Sale</td>
                                              <td align="center" style="color:Black;font-style:italic;font-weight:bold;"><%# StrCurrency + DataBinder.Eval(Container.DataItem, "Total")%></td>
                                            </tr>
                                      ...
                                      <tr>
                                        ...
                                        <%--<div id = "Employees" runat="server" visible="false">--%>
                                          ...
                                          <tr>
                                            ...
                                            <td align="center" style="color:Black; font-style:italic;"><%# StrCurrency + DataBinder.Eval(Container.DataItem,"Amount") %></td>
                                          </tr>
                                    ...
                                    <input type="hidden" id="ClntDtTm" runat="server" value="" />
                                    <script  type="text/javascript">
                                        document.getElementById('<%=ClntDtTm.ClientID %>').value = getClientCurrentDateTime();
                                    </script>
								</div>
					        </fieldset>
