<%@ Page Language="C#"  MasterPageFile="~/innerpage.master" AutoEventWireup="true"  CodeFile="~/periodic_zreport.aspx.cs" Inherits="PosReport.periodic_zreport"  %>
...
--%>                                 </td>
									...
									<table>
							            <thead>
								            <tr style="background-color:#000000; color:#ffffff">
								               <td></td> <td></td><td></td><td></td><td align="center" style="font-weight:bold">Sales History</td>
								            </tr>
    	        						</thead>
                ...
                <asp:Label ID="location" runat="server" Visible="false"></asp:Label>
                                  ...
                                  <tr>
                                        <td align="left"><label id="LblRepo" align="center" runat="server"></label></td>
                                  </tr>
                                      <tr>
                                        <td align="left">
                                        <div id = "z_report" runat="server" visible="false">
                                          ...
                                          <tr>
                                            ...
                                            <td align="right" style="color:Black; font-style:italic;"><%= StrCurrency + String.Format("{0:0.00}",CashSale) %></td>
                                          </tr>
                                          <tr>
                                            <td align="left" style="color:Black;">Card</td>
                                            <td align="right" style="color:Black;font-style:italic;"><%= StrCurrency + String.Format("{0:0.00}",CardSale) %></td>
                                          </tr>
                                          <tr>
                                            <td align="left" style="color:Black;">Voucher</td>
                                            <td align="right" style="color:Black;font-style:italic;"><%= StrCurrency + String.Format("{0:0.00}",VoucherSale) %></td>
                                          </tr>
                                          <tr>
                                            <td align="left" style="color:Black;">TIPS(+)</td>
                                            <td align="right" style="color:Black;font-style:italic;"><%= StrCurrency +  String.Format("{0:0.00}", TipAmount)%></td>
                                          </tr>
                                          <tr>
                                            <td align="left" style="color:Black;">Total Discount</td>
                                            <td align="right" style="color:Black;font-style:italic;"><%= StrCurrency + String.Format("{0:0.00}",Discount) %></td>
                                          </tr>
                                          <tr>
                                            <td align="left" style="color:Black;">Total Surcharge</td>
                                            <td align="right" style="color:Black;font-style:italic;"><%= StrCurrency +  String.Format("{0:0.00}", SurCharge)%></td>
                                          </tr>
                                          <tr>
                                            <td align="left" style="color:Black;">FLOAT(+)</td>
                                            <td align="right" style="color:Black;font-style:italic;"><%= StrCurrency + String.Format("{0:0.00}", TotalFloatAmt)%></td>
                                          </tr>
                                          <tr>
                                            <td align="left" style="color:Black;">REFUND)</td>
                                            <td align="right" style="color:Black;font-style:italic;"><%= StrCurrency + String.Format("{0:0.00}", TotalRefundAmt)%></td>
                                          </tr>
                                          <tr>
                                            <td align="left" style="color:Black;">PAYOUT(-)</td>
                                            <td align="right" style="color:Black;font-style:italic;"><%= StrCurrency + String.Format("{0:0.00}", TotalPayoutAmt)%></td>
                                          </tr>
                                          
                                          <tr>
                                            <td align="left" style="color:Black;">GST Included (10 %)</td>
                                            <td align="right" style="color:Black;font-style:italic;"><%= StrCurrency + String.Format("{0:0.00}",TaxAmt) %></td>
                                          </tr>

                                          <tr>
                                            <td align="left" style="color:Black;">No Sale Count</td>
                                            <td align="center" style="color:Black;font-style:italic;"><%= String.Format("{00}", noSaleCount)%></td>
                                          </tr>

                                          <tr>
                                            <td align="left" style="color:Black;">TOTAL Gross Sale</td>
                                            <td align="right" style="color:Black;font-style:italic;"><%= StrCurrency + String.Format("{0:0.00}",TotalGrossAmt) %> </td>
                                          </tr>
<%--                                          <tr>
...
--%>                                        </table>
                                    ...
                                    <div id = "Employee" runat="server" visible="false">
                                      ...
                                      <tr>
                                            <td align="left" style="font-weight:bold">Individual Employee's Breakdown</td>
                                      </tr>
                                      ...
                                      <tr>
                                        ...
                                        <%--<div id = "Employees" runat="server" visible="false">--%>
                                          ...
                                          <tr>
                                            <td align="left" style="color:Black; background:white;">Cash</td>
                                            <td align="right" style="color:Black; background:white; font-style:italic;"><%# StrCurrency + DataBinder.Eval(Container.DataItem, "CashSale")%></td>
                                          </tr>
                                          <tr>
                                            <td align="left" style="color:Black;">Card</td>
                                            <td align="right" style="color:Black;font-style:italic;"><%# StrCurrency + DataBinder.Eval(Container.DataItem, "CardSale")%></td>
                                          </tr>
                                          <tr>
                                            <td align="left" style="color:Black; background:white;">Voucher</td>
                                            <td align="right" style="color:Black; background:white;font-style:italic;"><%# StrCurrency + DataBinder.Eval(Container.DataItem, "VoucherSale")%></td>
                                          </tr>
                                            <tr>
                                                <td align="left" style="color:Black; font-weight:bold">TOTAL</td>
                                              <td align="right" style="color:Black;font-style:italic;font-weight:bold;"><%# StrCurrency + DataBinder.Eval(Container.DataItem, "Total")%></td>
                                            </tr>
                                    ...
                                    <div id = "SubMenu" runat="server" visible="false">
                                      ...
                                      <tr>
                                            <td align="left" style="font-weight:bold">Sub-Category Sale Breakdown</td>
                                      </tr>
                                      <tr>
                                        <td align="left">
                                        <%--<div id = "Employees" runat="server" visible="false">--%>
                                          ...
                                          <tr>
                                            ...
                                            <td align="right" style="color:Black; font-style:italic;"><%# StrCurrency + DataBinder.Eval(Container.DataItem, "Amount")%></td>
                                          </tr>
                                          </ItemTemplate>
                                         <FooterTemplate>
                                    ...
                                    <div id = "Product" runat="server" visible="false">
                                      ...
                                      <tr>
                                        ...
                                        <%--<div id = "Employees" runat="server" visible="false">--%>
                                          ...
                                          <ItemTemplate>
                                          <tr>
                                            <td align="left" style="color:Black;"><%# DataBinder.Eval(Container.DataItem,"ProductName")%>(<%# DataBinder.Eval(Container.DataItem,"Qty") %>)</td>
                                            <td align="right" style="color:Black; font-style:italic;"><%# StrCurrency + DataBinder.Eval(Container.DataItem, "Amount")%></td>
                                          </tr>
                                          </ItemTemplate>
                                               <FooterTemplate>
                                    ...
                                    <div id = "ProductOption" runat="server" visible="false">
                                      ...
                                      <tr>
                                            <td align="left" style="font-weight:bold">Product Modifiers Sale Breakdown</td>
                                      </tr>
                                      <tr>
                                        <td align="left">
                                        <%--<div id = "Employees" runat="server" visible="false">--%>
