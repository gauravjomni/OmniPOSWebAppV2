<%@ Page Language="C#"  MasterPageFile="~/innerpage.master" AutoEventWireup="true"  CodeFile="~/Modifiers.aspx.cs" Inherits="PosModifiers.Modifiers"  %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
			...
			<ul class="shortcut-buttons-set">
				...
				<li><a class="shortcut-button" href="AddModifier.aspx"><span>
...
--%>				
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
					...
					<h3 style="cursor: s-resize;">Current Product Modifier(s)</h3>
					...
					<div style="display: block;" class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
					    ...
					    <asp:Literal ID="Msg" runat="server" Visible="false">
						    <div class="notification attention png_bg">
							    ...
							    <div>Permission Denied! This Modifer Is Already Attached With Any Product . Please Delete That Product First And Then You Can Delete That Modifier.</div>
						    </div>
					    </asp:Literal>		
                          ...
                          <asp:Repeater ID="ModfRepeater" runat="server" onitemdatabound="ModfRepeater_ItemDataBound">
							<HeaderTemplate>
							<tbody>
							</HeaderTemplate>
							<ItemTemplate>
								<tr class="alt-row">
									...
									<td>
										<!-- Icons -->
										 <a href='<%# "AddModifier.aspx?modfid=" + iTool.encryptString(DataBinder.Eval(Container.DataItem,"ModifierID").ToString()) + "&mode=edit" %>' title="Edit"><img src="images/pencil.png" alt="Edit"></a>
										 <a href="javascript:;" title="Delete" onclick="removerec('<%# iTool.encryptString(DataBinder.Eval(Container.DataItem,"ModifierID").ToString())%>','Modifiers.aspx')"><img src="images/cross.png" alt="Delete"></a>
										 <a href='<%# "AddModifier.aspx?modfid=" + iTool.encryptString(DataBinder.Eval(Container.DataItem,"ModifierID").ToString()) + "&mode=clone" %>' title="Clone"><img src="images/clone.png" alt="Clone"></a>
									</td>
								</tr>
							</ItemTemplate>
