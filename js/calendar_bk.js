...
//	email :	fuushikaden@yahoo.com
	...
	//var imgDir = "../p1/jscalender/"			// directory for images ... e.g. var imgDir="/img/"
	var imgDir = "jscalender/"				//change when not in p1 directory in web server
	...
	function constructCalendar () {
		...
		for	( datePointer=1; datePointer<=numDaysInMonth; datePointer++ )
		{
			...
			{ 
				...
				//{
				//	sHTML += "<b><<font color=#cccccc>&nbsp;" + datePointer + "</font>&nbsp;</b>"
				//}
				//else
				//{
			...
			{ 
				//if	((monthSelected <= monthNow-1)||(yearSelected <= yearNow-1))
				//{
				//	sHTML += "&nbsp;<font color=#cccccc>" + datePointer + "</font>&nbsp;" 
				//}
				//else
				//{
					//if	((datePointer <= dateNow-1)&&(monthSelected <= monthNow))
					//{
