<%@ Page Language="C#"  MasterPageFile="~/innerpage.master" AutoEventWireup="true"  CodeFile="~/ViewOrderTransaction_Company.aspx.cs" Inherits="PosReport.ViewOrderTransaction_Company"  %>
        ...
        EnableScriptLocalization="true" ID="ScriptManager1" />
			...
			<div class="content-box"><!-- Start Content Box -->
				<div class="content-box-header">
					...
					<h3 style="cursor: s-resize;">Order Transaction History [ For All Locations ]</h3>
...
--%>   
                ...
                <asp:Label ID="companyaddress" runat="server" Visible="false"></asp:Label>
								...
								<div style="width:1080px; float:left; font-size:12px;">
									<table style="font-size:12px;">
						            	...
						            	<ItemTemplate>
								            <tr class="alt-row">
									            ...
									            <td style="width:250px;"><%# String.Format("{0:MM/dd/yyyy hh:mm:ss tt}", DataBinder.Eval(Container.DataItem,"TransactionDate")) %></td>
                                                ...
                                                <td style="text-align:right;padding-right:25px;"><%# StrCurrency + DataBinder.Eval(Container.DataItem, String.Format("{0:00}", "TotalAmount"))%></td>
						            ...
						            <div style="margin:10px 5px 5px 5px; color:Green;" runat="server" id="MsgTip" visible="false">
						                <b>[CSH]</b> = <span style="color:Red">Cash Sales ,</span> <b>[CC]</b> = <span style="color:Red">Credit Card Sales,</span> <b>[Vcr]</b> = <span style="color:Red">Voucher Sales</span>
						            </div>    
