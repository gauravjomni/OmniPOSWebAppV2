<%@ Page Language="C#"  MasterPageFile="~/innerpage.master" AutoEventWireup="true"  CodeFile="~/AddUnit.aspx.cs" Inherits="PosUnit.AddUnit"  %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <uc_head:header_Ctrl ID="Header_Ctrl" runat="server" />
				...
				<li><a class="shortcut-button" href="UnitMaster.aspx"><span>
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
					...
					<h3 style="cursor: s-resize;"><asp:Literal ID="LblHead" runat="server" Text="Add Unit"></asp:Literal></h3>
							...
							<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
								...
								<p>
									<label>Unit Name</label>
										<input class="text-input x_small-input" id="txtUnitName" name="txtUnitName" type="text" runat="server" /> 
                                        <asp:RequiredFieldValidator ID="ReqdUnitName" runat="server" ErrorMessage=" *" ControlToValidate="txtUnitName"></asp:RequiredFieldValidator>
										<br /><small><asp:Label ID="LblUnit" runat="server" ForeColor="Red"></asp:Label></small>
								</p>
								...
								<p>
                                    ...
                                    <a href="UnitMaster.aspx" class="pageback">Back To Menu</a>
                                        <asp:HiddenField ID="UnitID" runat="server" Value ="-1" />
